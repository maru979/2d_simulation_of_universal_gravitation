var canvas = document.querySelector('canvas'),
	...
	planets = [
		...
		new Planet(Math.random() * 5 - 5, (Math.random() * 2) * Math.PI , 116, 4.8, '#009900'),
		new Planet(Math.random() * 5 - 5, (Math.random() * 2) * Math.PI , 216, 12.1, 'blue'),
		new Planet(Math.random() * 5 - 5, (Math.random() * 2) * Math.PI , 300, 12.7, '#1f75fe'),
	],
	maxParticles = 30000,
	emissionRate = 3
